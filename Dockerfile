FROM onepubtestacrdev.azurecr.io/public/windows/servercore:1909-amd64
ARG CERT
ARG CONFIGURL
...
RUN Invoke-RestMethod -Method Get -URI https://mcr.microsoft.com/v2/windows/servercore/manifests/1909-amd64 -UseBasicParsing -OutFile configValue
