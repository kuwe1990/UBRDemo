...
RUN 'Bearer ' + $(Invoke-RestMethod -Method Post -URI https://login.microsoftonline.com/72f988bf-86f1-41af-91ab-2d7cd011db47/oauth2/token -BODY @{grant_type = 'client_credentials'; resource = '1081c354-1883-40b9-96b0-4018a40b834d'; client_id = '4b0bab30-625c-4af4-8f5e-5deaa4a00b2a'; client_secret = $PASSWORD}).access_token > authToken
...
RUN Invoke-RestMethod -Method POST -Uri "https://onepubng-dev.azure-api.net/MediaRefreshServiceFabric/MediaRefreshServiceFabric/ServerContainerSFSvc/ServerContainerRelease/ValidateContainerInfo" #-Headers @{Authorization=$(Get-Content -Path authToken); runTimeBuildVersion='18362'; runTimeUbr='658'; product='Windows 10 1903'} -Body $(Get-Content -Path configValue_update3) -ContentType #"application/json" -UseBasicParsing
